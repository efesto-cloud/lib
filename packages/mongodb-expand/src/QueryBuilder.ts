...
> {
    ...
    private _expand_pipeline: Document[] = [];
    ...
    protected expand(
        ...
        this._expand_pipeline.push(...pipeline);
        return this;
    }
    ...
    build(): Document[] {
        ...
        // 6. Expand last - only join the final result set
        if (this._expand_pipeline.length > 0) {
            pipeline.push(...this._expand_pipeline);
        }
