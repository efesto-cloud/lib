...
```json
{
    "@efesto-cloud/unit-of-work": "^0",
    "@efesto-cloud/entity": "^0",
    "@efesto-cloud/env": "^0",
    "@efesto-cloud/maybe": "^0",
    "@efesto-cloud/metadata": "^0",
    "@efesto-cloud/mongodb-expand": "^0",
    "@efesto-cloud/expand": "^0",
...
```json
{
    ...
    "@efesto-cloud/env": "^0.0.4",
    "@efesto-cloud/maybe": "^0.0.4",
    "@efesto-cloud/metadata": "^0.0.4",
    "@efesto-cloud/mongodb-unit-of-work": "^0.0.4",
    "@efesto-cloud/mongodb-expand": "^0.0.4",
    "@efesto-cloud/expand": "^0.0.4",
